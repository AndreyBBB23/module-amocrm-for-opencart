...
class AmoCrmWidgets
{
    ...
    public $nameSpace = ""; // i.e. 'amocrm_backup_'
    public $params = ""; // i.e. array('amocrm_backup_status' => 1 );
        ...
        <div class="form-group" id="field_<?php echo $property; ?>" style="display: inline-block; width: 100%;">
            ...
            <div class="col-sm-4 text-right">
                <button onclick="$('#form').attr('action', '<?php echo $clear; ?>');
                        ...
                        $('#form').submit();" class="btn btn-primary"><span><?php echo $button_clear_log; ?></span>
                </button>
            </div>
        </div>
        <?php
    ...
    {
        ?>
        <div class="form-group<?php echo $required ? ' required' : ''; ?>" id="field_<?php echo $property; ?>"
    ...
    public function inputMultiStore($stores, $property)
    {
        ...
        <div class="form-group" id="field_<?php echo $property . '[0]'; ?>" style="display: inline-block; width: 100%;">
            <div class="col-sm-5">
                <label class="control-label"
                       for="<?php echo $this->nameSpace . $property . '[0]'; ?>"><?php echo $this->params['entry_' . $property]; ?></label>
                <br>
                <?php echo isset($this->params['entry_' . $property . '_desc']) ? $this->params['entry_' . $property . '_desc'] : '' ?>
            </div>
            <div class="col-sm-7">
        ...
        <div class="form-group <?php echo $property; ?>" id="field_<?php echo $field_id; ?>"
            ...
            <div class="col-sm-7">
                <ul class="nav nav-tabs">
                    <?php foreach ($languages as $language) { ?>
                        <li class="<?php echo $language['language_id'] == $this->config_language_id ? 'active' : ''; ?>">
                            <a href="#column-<?php echo $field_id ?>-<?php echo $language['language_id']; ?>"
                               data-toggle="tab">
                                <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png"
                                     title="<?php echo $language['name']; ?>">
                                <?php echo $language['name']; ?>
    ...
    public function listAutocomplete($property, $options)
    {
        ...
        <div class="form-group" id="field_<?php echo $property; ?>" style="display: inline-block; width:100%">
            ...
            <div class="col-sm-7">
                <input type="text" name="input-<?php echo $property; ?>" value=""
                       placeholder="<?php echo $this->params['entry_' . $property]; ?>"
                       id="input-<?php echo $property; ?>" class="form-control"/>
                <div id="list-<?php echo $property; ?>" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($options as $option) { ?>
                        <div id="<?php echo $property; ?><?php echo $option['id']; ?>"><i
                                    class="fa fa-minus-circle"></i> <?php echo $option['name']; ?>
                            <input type="hidden" name="auto-<?php echo $property; ?>[]"
                    ...
                    <div class="stores-group store-<?php echo $store_id ?> <?php echo $store_id != 0 ? 'hidden' : '' ?>">
                        <div class="well well-sm" style="height: 150px; overflow: auto;">
                            ...
                            <?php foreach ($options as $value => $name) { ?>
                                ...
                                <div class="<?php echo $class; ?>">
                                    <input type="checkbox"
                                           name="<?php echo $this->nameSpace . $property . "[{$store_id}]"; ?>[]"
                                           value="<?php echo $value; ?>"<?php
                        ...
                        <button type="button" onclick="$(this).parent().find(':checkbox').prop('checked', true);"
                                class="btn btn-primary"><i
                                    class="fa fa-pencil"></i> <?php echo $this->text_select_all; ?></button>
                        <button type="button" onclick="$(this).parent().find(':checkbox').prop('checked', false);"
                                class="btn btn-danger"><i
                                    class="fa fa-trash-o"></i> <?php echo $this->text_unselect_all; ?></button>
                    </div>
                <?php } ?>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <ul>
                    <?php if (isset($this->params['instruction_link'])) { ?>
                        <li>
                            <b><?php echo $this->params['entry_instruction']; ?></b> <?php echo $this->params['instruction_link']; ?>
                        </li>
                    <?php } ?>
                    <?php if (isset($this->params['history_link'])) { ?>
                        <li>
                            <b><?php echo $this->params['entry_history']; ?></b> <?php echo $this->params['history_link']; ?>
                        </li>
                    <?php } ?>
                    <?php if (isset($this->params['faq_link'])) { ?>
                        <li><b><?php echo $this->params['entry_faq']; ?></b> <?php echo $this->params['faq_link']; ?>
                        </li>
                    <?php } ?>
                </ul>
            </div>
